...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <aside
        className={`fixed top-0 left-0 w-60 h-screen flex flex-col bg-white border-r border-zinc-200 z-50 px-5 py-6 transition-transform duration-300 ease-in-out lg:translate-x-0 ${
      ...
      >
        ...
        <button
          onClick={close}
          className="absolute top-4 right-4 lg:hidden w-8 h-8 flex items-center justify-center rounded-lg hover:bg-zinc-100 transition-colors cursor-pointer bg-transparent border-none"
        >
        ...
        <div className="flex items-center gap-2.5 mb-8">
          <Image src="/image.png" alt="Metriva Logo" width={34} height={34} className="rounded-lg object-contain" />
